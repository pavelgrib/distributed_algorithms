...
public class Registrar {
	...
	public Registrar(int n) {
		...
		/* Synchronize worker threads and, consequently, base.Process.registeR() */
		lock = new Object();
	...
	public static void main(String[] args) {
		...
		if (args.length != 1) {
			System.err.println("usage: java base.Registrar [integer]");
			System.exit(1);
		}
		...
		Utils.out(server.pid, String.format("base.Registrar started; n = %d.",n));
		...
		while (! done) {	
			...
			try {
				...
				System.err.println("Error: failure to accept connection at base.Registrar.");
				System.err.println(e.getMessage());
				System.exit(1);
			}
			/* And so it begins... */

...
public class FaultManager extends Thread {
	...
	/* Parses `command` from a base.FaultInjector instance */
	...
	public void run() {
		...
		try {
			...
			System.err.println("Error: failed to launch base.FaultManager.");
		...
		while (! done) {
			...
			try {
				...
				System.err.println("Error: failed to accept connection from base.FaultInjector.");
				System.err.println(e.getMessage());
				System.exit(1);
			}
			...
			try {
				...
				while ((message = b.readLine()) != null) {
					/* Handle base.FaultInjector's command */
					if (! parse(message)) {
				...
				System.err.println("Error: failed to read/write at base.FaultManager.");
				System.err.println(e.getMessage());
				System.exit(1);
			}
		}
